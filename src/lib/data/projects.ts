...
export const projects: Project[] = [
  {
    ...
    tagline:
      "A backend broken into small, independently deployable NestJS services talking over a message broker.",
    stack: [
      "NestJS",
      "TypeScript",
      "RabbitMQ",
  ...
  },
  {
    ...
    tagline:
      "A Telegram bot that puts a human in the loop — Claude asks, I tap approve or deny, the agent continues.",
  ...
  },
  {
    ...
    tagline:
      "A Discord bot that handles the repetitive server work so moderators don`t have to.",
  ...
  },
  {
    ...
    tagline:
      "This very site: I designed every frame myself, then built it in SvelteKit.",
